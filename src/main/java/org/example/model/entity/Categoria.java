...
public class Categoria {
    ...
    @OneToMany(mappedBy = "idCategoria")
    private Set<org.example.model.entity.Recomendacion> recomendacions = new LinkedHashSet<>();
    ...
    public Set<org.example.model.entity.Recomendacion> getRecomendacions() {
        return recomendacions;
    }

    public void setRecomendacions(Set<org.example.model.entity.Recomendacion> recomendacions) {
